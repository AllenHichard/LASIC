...
def algoritmoGenetico(paths_treino, paths_teste, agregacao,composicao, temPeso):
    for dirTreino, dirTeste in zip(paths_treino, paths_teste):
        ...
        objetivo = Fitness.__getFitness__(obj_reader, semente, pesos, agregacao,composicao)
